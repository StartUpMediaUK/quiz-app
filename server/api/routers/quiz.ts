...
import type { QuestionCategory, Quiz } from "@prisma/client";
...
export const quizRouter = createTRPCRouter({
  ...
  createQuiz: publicProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      const { title, slug,description, questionCategories, published } = input
    ...
    editQuiz: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const { quizId, title, slug, description, questionCategories, published } = input;
